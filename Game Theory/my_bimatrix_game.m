...
disp("Sostituire il valore di x(2) = 1 - x(1), e y(2) = 1 - y(1)");
...
disp("Sostituire il valore di x(1) con 1 - x(2), e y(1) con 1 - y(2)");
...
disp(" ");
disp(" ");
disp("Le coppie di punti tale per cui x1 € B1(y1) e y1 € B2(x1) sono:");
